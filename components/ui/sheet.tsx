...
function SheetTrigger({ children, asChild, ...props }: SheetPrimitive.Trigger.Props & { asChild?: boolean }) {
...
function SheetClose({ children, asChild, ...props }: SheetPrimitive.Close.Props & { asChild?: boolean }) {
  if (asChild && React.isValidElement(children)) {
